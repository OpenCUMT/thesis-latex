    ...
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}m{3.5cm}|X|>{\centering\arraybackslash}m{2.0cm}|X|}
        ...
        \multicolumn{4}{|l|}{%
            \parbox[t][20cm][l]{\textwidth-2\ccwd}{%
                ...
                \vfill
                成绩：**\hspace{10\ccwd}指导教师签字：% \includegraphics[width=2.0cm]{path/to/signature.png}
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}m{3.5cm}|X|>{\centering\arraybackslash}m{2.0cm}|X|}
        ...
        \multicolumn{4}{|l|}{%
            \parbox[t][20cm][l]{\textwidth-2\ccwd}{%
                ...
                \vfill
                成绩：**\hspace{10\ccwd}评阅教师签字：% \includegraphics[width=2.0cm]{path/to/signature.png}
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}m{7cm}|X|X|X|X|X|}
        ...
        \multicolumn{6}{|c|}{
            \parbox[t][7cm][l]{\textwidth-2\ccwd}{%
                ...
                %******************************
                \vfill
                成绩：**\hspace{10\ccwd}答辩委员会主任签字：% \includegraphics[width=2.0cm]{path/to/signature.png}
